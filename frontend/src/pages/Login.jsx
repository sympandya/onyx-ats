            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <div className="mt-2">
                        <input value={email} type="email" onChange={e=>setEmail(e.target.value)} required className="block w-full rounded-md border border-gray-300 px-3 py-1.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#256a5e] sm:text-sm" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2 relative">
                            <input 
                                ...
                                required 
                                className="block w-full rounded-md border border-gray-300 px-3 py-1.5 pr-10 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#256a5e] sm:text-sm" 
                            />
                            <button
                                type="button"
                    ...
                    <button type="submit" disabled={isSubmitting} className="flex w-full justify-center rounded-md bg-[#256a5e] px-3 py-1.5 text-sm font-semibold text-white hover:bg-[#1d5349] disabled:opacity-70 transition-colors">
                        {isSubmitting ? "Authenticating..." : "Login"}
                    </button>
                </form>

                <p className="mt-10 text-center text-sm text-gray-600">
                    Not a member? <Link to="/signup" className="font-semibold text-[#256a5e] hover:text-[#1d5349] ml-1">Sign Up</Link>
                </p>
            </div>
        </div>
    )
